...
<template>
    ...
    <section class="arrival_section">
        ...
        <div class="box">
            <div class="arrival_bg_box">
                <img src="public/web/images/arrival-bg.png" alt="">
            </div>
            <div class="row">
    ...
    <section class="product_section layout_padding">
        ...
        <div class="row" v-if="products.length > 0">
            <div class="col-sm-6 col-md-4 col-lg-4" v-for="product in products" :key="product.id">
                <div class="box">
                    ...
                    <div class="img-box">
                        <img :src="getImage(product.thumbnail)">
                    </div>
                    <div class="detail-box">
                        <h5>{{ product.title }}</h5>
                        <h6>${{ product.price }}</h6>
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <div class="subscribe_form ">
                        ...
                        <form action="">
                            <input type="email" placeholder="Enter your email" id="email" v-model="subscribe.email">
                            <button type="button" @click="SubscriberSave()">subscribe</button>
                        </form>
                    </div>
                </div>
            </div>
                            ...
                            <div class="img_container">
                                <div class="img-box">
                                    <div class="img_box-inner">
                                        <img src="public/web/images/client.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="detail-box">
