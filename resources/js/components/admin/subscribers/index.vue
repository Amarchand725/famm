<script setup>
    ...
    const getRecords = async () => {
        let  response = await axios.get('/api/admin/subscribers')
    ...
    const deleteRecord = (id) => {
        ...
        .then((result) => {
            if(result.value){
                axios.get('/api/admin/subscribers/destroy/'+id)
                .then(() => {
                    Swal.fire(
                        'Delete',
                        'Subscriber delete successfully',
                        'success',
                    )
                    getRecords()
                })
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><router-link to="/admin/subscribers">Subscribers</router-link></li>
                            </ol>
                        </div>
                    </div>
                </div>
